# WAP to implement a queue with size limit.
...
class Queue:
    ...
    def isFull(self):
        if self.queueList is None:
            return False
        elif len(self.queueList) == self.size:
            return True
        else:
            return False

queueSize = int(input("Enter the size of the queue : "))   
queueObj = Queue(queueSize)
...
while True:
    ...
    print("6. PEEK")
    print("7. Check Is the Queue Is FULL")
    print("8. EXIT")
